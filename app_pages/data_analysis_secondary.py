...
def data_analysis_secondary():
    ...
    st.info(
        ...
        " (scores 21 to 40 for all, plus the 0 to 20 bin for maths),"
        ...
        " pass through the `completed` gate of the test_preparation_course"
        ...
        " of lines pass through the `female` gate in the reading_score"
        " and writing_score parallel plots."
        f"\n\n"
        ...
        " D and E, participate in the standard lunch program, participate"
        " in the test preparation course and have better educated parents."
        f"\n\n"
