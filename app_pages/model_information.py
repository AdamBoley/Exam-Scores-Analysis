...
def model_information():
    ...
    st.info(
        ...
        " Machine Learning part of this project. This page partially"
        " fulfils business requirement 2."
        f"\n\n"
        ...
        " Each model labels these classes differently."
        " This is because of the numerical score at which the"
        " breakpoint or split between the classes occurs."
        " This is discussed in greater detail in the specific"
        " section that concerns each model."
    )
    ...
    st.info(
        ...
        " for a StandardScaler step."
        " There is also no need for a SmartCorrelatedSelection step,"
        " as my analyses showed that, while there are"
        " correlations within the categorical variables,"
        " these are too slight to warrant the removal of any"
        " categorical variables in the pipeline. All we need is an"
